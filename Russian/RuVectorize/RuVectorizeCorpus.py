...
corpus = pd.read_csv("/home/nsborodin/Maksim/Russian/RuPreprocessed/RuPreprocessedWithSep.csv")
word_vector_dict = json.load(open("/home/nsborodin/Maksim/Russian/RuPreprocessed/RuWordVectorDict8.json"))
